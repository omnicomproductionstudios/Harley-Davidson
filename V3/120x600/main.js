...
function animate() {
  ...
  tl.addLabel("frame1", 1)
    .to(logo, 1, { width: 88, x: 11, y: -5, ease: "power1.inOut" }, "frame1")
    .to(img, 1, { width: 104, height: 423, x: 8, y: 8, ease: 'Sine.easeOut' }, "frame1")
    .to(bg1, 1, { width: 104, height: 423, x: 0, y: 0, ease: 'Sine.easeOut'}, "frame1")
