...
function animate() {
  ...
  tl.addLabel("frame1", 1)
    .to(logo, 1, { width: 96, x: -1.5, y: 8, ease: "power1.inOut" }, "frame1")
    .to(img, 1, { width: 519, height: 74, x: 8, y: 8, ease: 'Sine.easeOut' }, "frame1")
    .to(bg1, 1, { width: 519, height: 74, x: 0, y: 0, ease: 'Sine.easeOut'}, "frame1")
    .from(".copy1 .line", { xPercent: -120, stagger: 0.2, ease: "power1.inOut" }, "frame1+=1")
